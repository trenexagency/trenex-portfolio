...
import logoUrl from "@assets/Trenex_Logo_1784038658117.svg";

/* ══════════════════════════════════════════════════════
   GRAPHIC DESIGN — CINEMATIC ENTRANCE
   Same self-contained pattern as VideoEditingIntro /
   WebDevelopmentIntro: auto-plays once on mount, holds on
   a large centered logo + tagline over the site's dark
   red/black theme, then crossfades away to reveal the Hero
   section underneath — no user interaction, no spinner.

   Step 1 — logo fades in (large, centered)
   Step 2 — soft red glow blooms in behind the logo
   Step 3 — "Creative. Bold. Impactful." tagline fades up
   Step 4 — after ~2.7s the whole overlay smoothly
            crossfades into the hero section (no hard cut)
══════════════════════════════════════════════════════ */
...
export function GraphicDesignIntro() {
